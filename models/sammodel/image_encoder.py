...
class ImageEncoderViT(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        c6 = self.neck(c6.permute(0, 3, 1, 2))
        c12 = self.neck(c12.permute(0, 3, 1, 2))
        c18 = self.neck(c18.permute(0, 3, 1, 2))
        c24 = self.neck(c24.permute(0, 3, 1, 2))

        return y, (c6, c12, c18, c24)
